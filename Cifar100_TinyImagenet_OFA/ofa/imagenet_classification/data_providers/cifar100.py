...
class Cifar100DataProvider(DataProvider):
    ...
    def train_dataset(self, _transforms):
        train_set = torchvision.datasets.CIFAR100(self.DEFAULT_PATH,train=True,transform=_transforms,download=True)
        return train_set

    def test_dataset(self, _transforms):
        test_set = torchvision.datasets.CIFAR100(self.DEFAULT_PATH,train=False,transform=_transforms,download=True)
        return test_set
