...
if __name__ == "__main__":
    ...
    args.teacher_path = "OFAWeights/OFA/V5/acc69.32%_OFA"
    ...
    if args.task == "kernel":
        ...
        if args.phase == 1:
            args.ofa_checkpoint_path = "OFAWeights/OFA/V5/acc69.32%_OFA"
        else:
            args.ofa_checkpoint_path = "exp/kernel2kernel_depth/phase1/checkpoint/checkpoint.pth.tar"
        ...
        if args.phase == 1:
            args.ofa_checkpoint_path = "exp/kernel2kernel_depth/phase2/checkpoint/checkpoint.pth.tar"
        else:
