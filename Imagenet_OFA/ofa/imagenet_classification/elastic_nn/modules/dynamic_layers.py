...
class DynamicMBConvLayer(MyModule):
    ...
    def re_organize_middle_weights(self, expand_ratio_stage=0,k=1):
        ...
        sorted_idx = self.GaussianMixture_Difference(self.point_linear.conv.conv.weight.data,k)
        print(k)
