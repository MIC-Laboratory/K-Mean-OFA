...
class OFAMobileNetV3(MobileNetV3):
    def __init__(
        ...
        self.k_mean_number = [2,2,12,2,20,24,53,2,64,3,39,38,73,10,1,1,1,1,1,1,1,1,1]
    ...
    def re_organize_middle_weights(self, expand_ratio_stage=0):
        for index,block in enumerate(self.blocks[1:],0):
            block.conv.re_organize_middle_weights(expand_ratio_stage,self.k_mean_number[index])
